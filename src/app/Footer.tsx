    ...
    <footer className="saksFooter">
      <div className="saksFooterInner">
        <Link href="/" className="saksFooterLogo">
          ...
          <img src={logo} alt={logoAlt} style={{ height: 180, width: "auto", display: "block", maxWidth: "320px" }} />
        </Link>
        ...
        <div className="saksFooterGrid">
          <div className="saksFooterCol">
            <h3 className="saksFooterColTitle">{COL_EVENTO.title}</h3>
            <ul>
              {COL_EVENTO.links.map(link => (
                <li key={link.label}>
                  <Link href={link.href} className="saksFooterLink">{link.label}</Link>
                </li>
              ))}
            </ul>
          </div>
            ...
            <div className="saksFooterSocials">
              {SOCIALS.map(s => (
                <a
                  key={s.label}
                  href={s.href}
                  className="saksFooterSocialIcon"
                  aria-label={s.label}
                  target="_blank"
